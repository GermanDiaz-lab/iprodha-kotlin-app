...
class SecondActivity : AppCompatActivity() {
        ...
        lifecycleScope.launch {
            whenStarted {
                if (writePermissionGranted) {
                    ...
                    Toast.makeText(this@SecondActivity, "ERROR NO PERMISO", Toast.LENGTH_SHORT)
                        .show()
            ...
            if(readPermissionGranted) {
                loadPhotosFromExternalStorageIntoRecyclerView()
                    ...
                    alertDialogBuilder.setPositiveButton(android.R.string.ok) { dialog, which ->
                        val intent = Intent(this@SecondActivity, Settings.ACTION_APPLICATION_SETTINGS::class.java)
    ...
    private suspend fun savePhotoToExternalStorage(displayName: String, numeroObra: String, bmp: Bitmap): Boolean {
        return withContext(Dispatchers.IO) {
            ...
            val relativeLocation = Environment.DIRECTORY_PICTURES + File.separator + "obras$numeroObra"
            bmp.recycle()
    ...
    private suspend fun loadPhotosFromExternalStorage(obraid: String): List<SharedStoragePhoto> {
        ...
        return withContext(Dispatchers.IO) {
            ...
            val photosList = sqliteHelper.getAllFotos(obraid)
   ...
   // }
    ...
    private suspend fun saveWatermarkFoto(uri: Uri){
                    ...
                    val bmp = loadPhoto(uri)
                    val items = sqliteHelper.getObra(intent.getIntExtra("Id", 0).toString())
    ...
    private fun loadPhotosFromExternalStorageIntoRecyclerView() {
        lifecycleScope.launch {
            val photos = loadPhotosFromExternalStorage(intent.getIntExtra("Id", 0).toString())
    ...
    private fun changeActivity(photoUri: Uri, id: Int) {
        ...
        val intent = Intent(this@SecondActivity, ImagenActivity::class.java)
    ...
    private fun addFoto(uri: Uri){
        Log.d("TAG", "addFoto")
                ...
                val id = sqliteHelper.getObra(intent.getIntExtra("Id", 0).toString())
                val fotouri = uri
                ...
                val fml = FotoModel(nombrefoto = fotonombre, fotouri = fotouri, obraid = obraid, convid = 0, syncfoto = syncfoto, fotolatitud = latitud, fotolongitud = longitud, fechafoto = fechafoto)
