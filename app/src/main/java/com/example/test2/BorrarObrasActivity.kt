...
import com.example.test2.databinding.ActivityBorrarObrasBinding
import com.google.android.material.navigation.NavigationView
import kotlinx.coroutines.launch

class BorrarObrasActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBorrarObrasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBorrarObrasBinding.inflate(layoutInflater)
    ...
    private fun setupObraRecyclerView() = binding.borrarObraItem.apply {
        ...
        layoutManager = LinearLayoutManager(this@BorrarObrasActivity, LinearLayoutManager.VERTICAL, false)
    ...
    private fun alertBorrarObra (oListintent: ObraModel){
        ...
        var builder = AlertDialog.Builder(this@BorrarObrasActivity)
        ...
        builder.setPositiveButton("Si", DialogInterface.OnClickListener { dialogInterface, i ->
            ...
            sqliteHelper.borrarAllFoto(oListintent.id.toString())
            loadObraFromDbIntoRecyclerView()
    ...
    private fun borrarObra(oListintent: ObraModel): Int {
        return sqliteHelper.borrarObraItems(oListintent)
    }
